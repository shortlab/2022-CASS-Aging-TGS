...
echo "FileName, PeakFrequency(Hz), FrequencyError, ThermalDiffusivity(m2/s), ThermalError, Tau\n" >> Compiled-Analysis.csv
...
/Applications/MATLAB_R2020b.app/Contents/MacOS/MATLAB -nodisplay -nodesktop -r "cd('~/Desktop/CF3/2020-08-06'); GoGo"
