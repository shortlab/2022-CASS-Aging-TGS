...
echo "FileName, TimeIndex, PeakFrequency(Hz), FrequencyError, ThermalDiffusivity(m2/s), ThermalError, Tau\n" >> Compiled-Analysis.csv
...
## Get each POS file in the directory
...
/Applications/MATLAB_R2020b.app/Contents/MacOS/MATLAB -nodisplay -nodesktop -r "cd('~/Desktop/CF3/CF3_1.5kh/2020-08-06'); GoGo"
